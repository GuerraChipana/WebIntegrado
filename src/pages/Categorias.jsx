        ...
        <main>
            <section id="Categorias" className="categories">
                ...
                <div className="container">
                    <Link to="/productos?categoria_id=1" className="category">
                    ...
                    <Link to="/productos?categoria_id=2" className="category">
                    ...
                    <Link to="/productos?categoria_id=3" className="category">
